...
switch cmd
    ...
    case 'clone'
        fprintf([ ...
            ...
            'jgit clone [--bare] [-o|--origin <name>] [-b|--branch <name>]\n', ...
            '[--recursive|--recurse-submodules] [-n|--no-checkout] [--]\n', ...
            '<repository> [<directory>]\n', ...
            'Reference: <a href="http://git-scm.com/docs/git-checkout">git-clone</a>\n'])
    case 'commit'
        fprintf([ ...
            'COMMIT - Record changes to the repository\n', ...
            'jgit commit [-a|--all] [--amend] [-m <msg>|--message=<msg>]\n', ...
            '[--author=<author>] [-o|--only] [--] [<file>...]\n', ...
