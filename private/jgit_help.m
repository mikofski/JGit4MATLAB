...
switch cmd
    ...
    case 'merge'
        fprintf([ ...
            ...
            'Note: JGit has no ''OCTOPUS'' strategy so only one commit can be merged.\n', ...
            'Abort: Use jgit ''reset --hard HEAD'' to abort unfinished merge.\n', ...
            'Note: Use 3rd party merge tool such as ', ...
            '<a href="http://www.perforce.com/product/components/perforce-visual-merge-and-diff-tools">', ...
            'P4Merge</a> or <a href="https://code.google.com/p/meld-installer/">Meld</a>.\n', ...
